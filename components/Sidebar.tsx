...
const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    <>
      ...
      <aside className={`fixed inset-y-0 left-0 w-72 border-r border-white/10 flex flex-col h-full bg-[#080808] text-sm z-50 shrink-0 transition-transform duration-500 ease-out lg:translate-x-0 lg:static ${isOpen ? 'translate-x-0 shadow-[20px_0_60px_rgba(0,0,0,0.8)]' : '-translate-x-full'}`}>
